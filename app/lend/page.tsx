...
const collections = [
  ...
  },
  {
    ...
    name: "Tsunami NFT",
    logo: "/placeholder.svg?height=60&width=60",
    loanDemand: "3,200 APT",
    floorPrice: "8 APT",
    avgAPY: "7.5%",
    avgDuration: "4.3 days",
  },
]
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Review loan offers backed by NFTs. Fund loans, earn yield, and receive NFTs if borrowers default.
          </p>
        </div>
          ...
          <div className="glass-card p-6">
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center space-y-4 lg:space-y-0">
              <div className="flex flex-wrap gap-4">
                <select className="bg-white/5 border border-white/10 rounded-xl px-4 py-2 text-white focus:outline-none focus:border-blue-500">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {loanRequests.map((request) => (
              <LoanRequestCard key={request.id} request={request} onFundLoan={() => setSelectedLoan(request)} />
            ))}
          </div>
        </section>
          ...
          <div className="glass-card p-8 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
                Stake $GUI tokens to get lending priority and earn bonus rewards on all your funded loans.
              </p>
